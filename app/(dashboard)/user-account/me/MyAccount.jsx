          ...
          <div>
            ...
            <header>
              ...
              >
                ...
                <button
                  className="nav-btn nav-close-btn absolute top-0 left-0 m-3"
                  onClick={showNavbar}
                >
            ...
            <div className=" md:grid md:grid-cols-3 gap-10">
              <div className="pb-[50px] px-[30px] rounded-md">
                ...
                <div className="mt-[50px] md:mt-[100px]  md:block">
                  <button
                    onClick={handleLogout}
                    className="btn w-full bg-[#181A1E] p-3 text-[16px] leading-7 rounded-md hidden md:block text-white"
                  >
                    Deconectare
                  </button>
                </div>
                  ...
                  <button
                    ...
                    className={`${
                      tab === "bookings"
                        ? "bg-primaryColor text-white"
                        : "text-headingColor"
                    } flex-1 py-2 px-5 rounded-md font-semibold text-[16px] leading-7 border border-solid border-primaryColor hidden md:block`}
                  >
                    Programările Mele
                  </button>
                  ...
                  <button
                    ...
                    className={`${
                      tab === "settings"
                        ? "bg-primaryColor text-white"
                        : "text-headingColor"
                    } flex-1 py-2 px-5 ml-5 rounded-md font-semibold text-[16px] leading-7 border border-solid border-primaryColor hidden md:block`}
                  >
                    Profil
                  </button>
                </div>
