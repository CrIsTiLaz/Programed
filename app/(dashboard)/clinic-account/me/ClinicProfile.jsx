...
function Profile({ clinicData }) {
  ...
  const updateProfileHandler = async (e) => {
    ...
    try {
      ...
      console.error(
        "Eroare! A apărut o problemă la actualizarea profilului:",
        error
      );
      Swal.fire({
        title: "Error!",
              ...
              >
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="form__input"
                    value={
                      index !== -1 && openingHours[index].startTime
                        ? format(openingHours[index].startTime, "HH:mm")
                        : ""
                    }
                    onChange={(e) =>
                  ...
                  <input
                    ...
                    className="form__input"
                    value={
                      index !== -1 && openingHours[index].endTime
                        ? format(openingHours[index].endTime, "HH:mm")
                        : ""
                    }
                    onChange={(e) =>
        ...
        <div className="mb-5">
          ...
          {formData.photos.map((photo, index) => (
            <div key={index} className="mb-5 flex items-center">
              {loading ? (
                <div className="w-[60px] h-[60px] flex items-center justify-center mr-2">
