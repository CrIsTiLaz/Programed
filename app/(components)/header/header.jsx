        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="menu flex flex-col lg:flex-row items-center gap-[2.7rem] relative">
              ...
              >
                {" "}
                {/* Stilul pentru a se asigura că butonul este deasupra meniului */}
          ...
          <div className="flex items-center gap-4">
            <button
              className="lg:hidden text-3xl menu-toggle"
              onClick={toggleMenu}
            >
              <BiMenu />
            </button>
            {token && user ? (
              <div
                className={`${
                  pathname === "/doctor-account/me" ||
                  pathname === "/clinic-account/me " ||
                  pathname === "/admin" ||
                  pathname === "/user-account/me "
