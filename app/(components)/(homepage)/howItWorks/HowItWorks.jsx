  ...
  return (
    <>
      <section ref={containerRef}>
        {" "}
        {/* Atașați ref la secțiune */}
        <div className="container">
          <div className="lg:w-[470px] mx-auto">
            <h2 className="heading text-center">
              Servicii medicale de top pentru tine
            </h2>
          ...
          >
            <motion.div variants={images} className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  {" "}
                  Explorează rețeaua noastră vastă de cabinete medicale și
                  clinici, accesibilă doar prin câteva clicuri
                </p>
            ...
            <motion.div variants={images} className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  {" "}
                  Alătură-te comunității noastre și beneficiezi de acces rapid
                  la servicii medicale de top
                </p>
                <motion.div whileHover={{ scale: 1.1 }}>
                  <Link
                    href="/user-register"
            ...
            <motion.div variants={images} className="py-[30px] px-5">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                  {" "}
                  Înregistrează-ți cabinetul pe platforma noastră pentru a
                  beneficia de un sistem de programări modern.
                </p>
                <motion.div whileHover={{ scale: 1.1 }}>
                  <Link
